      ...
      <div className="mx-auto w-full md:w-4xl xl:w-6xl md:max-w-4xl xl:max-w-6xl">
        <div className="text-center mt-28 mb-20">
          ...
          <h2 className="leading-loose">
            ...
            <br />
            Applies search parameters for <pre className="inline">
              page
            </pre> and <pre className="inline">limit</pre> to the current URL.
            <br />
          ...
          <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            <p className="text-sm text-blue-800">
              ...
              instead of links. This enables loading indicators while the page
              is changing!
            </p>
          </div>
          ...
          <div className="flex justify-center mb-4">
            <Link
              href="https://github.com/bryaneaton13/shadcn-next-link-pagination"
              target="_blank"
            >
              <Button
                variant="secondary"
                className="border border-foreground hover:shadow-lg transition-all"
              >
