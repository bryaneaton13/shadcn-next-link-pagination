        ...
        <div className="text-center mt-28 mb-20">
          ...
          <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            <p className="text-sm text-blue-800">
              <strong>New:</strong> You can now use{" "}
              <code className="bg-blue-100 px-1 py-0.5 rounded">navigationMode="router"</code>
              to navigate with
              <br />
              <code className="bg-blue-100 px-1 py-0.5 rounded">router.push()</code> instead of links. This enables
              loading indicators while the page is changing!
            </p>
          </div>

          <div className="my-8 space-y-4">
            <div className="flex flex-col gap-4 rounded p-3">
              <h2 className="text-2xl font-bold mb-2">
                With <code className="bg-blue-100 px-1 py-0.5 rounded">{"<Link />"}</code>
              </h2>
              <Suspense>
                <Item />
              </Suspense>
            ...
            <div className="flex flex-col gap-4 rounded p-3">
              <h2 className="text-2xl font-bold mb-2">
                With <code className="bg-blue-100 px-1 py-0.5 rounded">router.push()</code>
              </h2>
              <Suspense>
                <Item navigationMode="router" />
              </Suspense>
            </div>
          </div>
